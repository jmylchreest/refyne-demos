...
-- Pre-loads 1 example tutorial

-- Tutorial 1: Simple Phone Stand
INSERT OR REPLACE INTO tutorials (id, title, overview, image_url, difficulty, estimated_time, source_url)
VALUES (
  'seed-phonestand-001',
...
INSERT OR REPLACE INTO materials (id, tutorial_id, item, quantity, notes, sort_order) VALUES
...
INSERT OR REPLACE INTO steps (id, tutorial_id, step_number, title, instructions, tips) VALUES
